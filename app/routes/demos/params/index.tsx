  ...
  return (
    <>
      ...
      <p>
        ...
        Remix automatically catches it, {"won't"} even try to render the
        component, but it will render the {"route's"} ErrorBoundary instead. If
        the route {"doesn't"} have one, it will bubble up to the routes above it
        until it hits the root.
      </p>
      ...
      <p>
        ...
        This is great when loading data from a database {"isn't"} found. As soon
        as you know you {"can't"} render the component normally, throw a 404
        response and send your app into the catch boundary. Just like error
        boundaries, catch boundaries bubble, too.
      </p>
    </>
  );
}
